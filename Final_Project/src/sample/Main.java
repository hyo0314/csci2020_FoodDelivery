...
public class Main extends Application {
    ...
    public void mainStage() throws Exception{
        ...
        Label restaurant = new Label("Enter restaurant name here: ");
        fill.add(restaurant, 10, 10);

        TextField resName = new TextField();
        resName.setPromptText("restaurant name here");
        fill.add(resName, 10, 11);
    ...
    public void menuStage() throws Exception{
        ...
        menuStage.setScene(new Scene(menuLayout, 500, 500));
    }
